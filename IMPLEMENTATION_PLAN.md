...
const correctCount = responses.filter((r, i) =>
  r.selected_index === questions[i].correct_index
).length;
...
const last20PercentCorrect = responses.slice(last20PercentIndex)
  .filter((r, i) => r.selected_index === questions[last20PercentIndex + i].correct_index)
  .length;
